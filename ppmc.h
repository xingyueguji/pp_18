...
// Wed Sep 24 16:19:37 2025 by ROOT version 6.32.06
// from TTree myTree/My TTree of dimuons
// found on file: combined_pp_mc.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Short_t         Reco_QQ_type[3];   //[Reco_QQ_size]
   Short_t         Reco_QQ_sign[3];   //[Reco_QQ_size]
   TClonesArray    *Reco_QQ_4mom;
   Short_t         Reco_QQ_mupl_idx[3];   //[Reco_QQ_size]
   Short_t         Reco_QQ_mumi_idx[3];   //[Reco_QQ_size]
   ULong64_t       Reco_QQ_trig[3];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_isCowboy[3];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctau[3];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctauErr[3];   //[Reco_QQ_size]
   Float_t         Reco_QQ_cosAlpha[3];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctau3D[3];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctauErr3D[3];   //[Reco_QQ_size]
   Float_t         Reco_QQ_cosAlpha3D[3];   //[Reco_QQ_size]
   Short_t         Reco_QQ_whichGen[3];   //[Reco_QQ_size]
   ...
   Short_t         Reco_mu_type[4];   //[Reco_mu_size]
   Short_t         Reco_mu_whichGen[4];   //[Reco_mu_size]
   Int_t           Reco_mu_SelectionType[4];   //[Reco_mu_size]
   Short_t         Reco_mu_charge[4];   //[Reco_mu_size]
   TClonesArray    *Reco_mu_4mom;
   ULong64_t       Reco_mu_trig[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_InTightAcc[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_InLooseAcc[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_highPurity[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isPF[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isTracker[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isGlobal[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isSoftCutBased[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isHybridSoft[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isMedium[4];   //[Reco_mu_size]
   Bool_t          Reco_mu_isTightCutBased[4];   //[Reco_mu_size]
   Short_t         Reco_mu_candType[4];   //[Reco_mu_size]
   Int_t           Reco_mu_nPixValHits[4];   //[Reco_mu_size]
   ...
   Short_t         Gen_QQ_mupl_idx[1];   //[Gen_QQ_size]
   Short_t         Gen_QQ_mumi_idx[1];   //[Gen_QQ_size]
   Short_t         Gen_QQ_whichRec[1];   //[Gen_QQ_size]
   Short_t         Gen_mu_size;
   Short_t         Gen_mu_charge[1];   //[Gen_mu_size]
   TClonesArray    *Gen_mu_4mom;
   Short_t         Gen_mu_whichRec[1];   //[Gen_mu_size]
...
#ifdef ppmc_cxx
ppmc::ppmc(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0)
   {
      TFile *f = TFile::Open("~/ROOTFILES/combined_pp_mc.root");
...
Int_t ppmc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ppmc::LoadTree(Long64_t entry)
{
